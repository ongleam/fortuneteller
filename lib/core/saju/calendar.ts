 ...
 * 음력을 양력으로 변환
 */
export function lunarToSolar(year: number, month: number, day: number, isLeap: boolean = false): SolarDate {
    // 간단한 근사치 계산
    let solarYear = year;
 ...
 */
export function getTimeToEarthlyBranch(timeInput: string | number): string {
