...
export const MoonIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M9.598 1.591a.75.75 0 01.785-.175 7 7 0 11-8.967 8.967.75.75 0 01.961-.96 5.563 5.563 0 007.04-7.04.75.75 0 01.175-.785z"
        fill="currentColor"
      />
    </svg>
  );
...
export const SunIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M8 0.5V2M8 14V15.5M15.5 8H14M2 8H0.5M13.5 2.5L12.5 3.5M3.5 3.5L2.5 2.5M13.5 13.5L12.5 12.5M3.5 12.5L2.5 13.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function KakaoIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <ellipse cx="9" cy="9" rx="9" ry="9" fill="#FEE500" />
      <path
        d="M9 4.5C5.686 4.5 3 6.537 3 9.02c0 1.37 1.01 2.58 2.55 3.34l-.27.96c-.04.14.09.27.23.23l1.13-.36c.7.13 1.44.2 2.09.2 3.314 0 6-2.037 6-4.52S12.314 4.5 9 4.5z"
        fill="#3C1E1E"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.11 9.41L2.86 10.66L3.86 11.66L5.11 10.41C5.36 10.77 5.69 11.08 6.05 11.33L4.8 12.58L5.8 13.58L7.05 12.33C7.63 12.55 8.3 12.58 8.95 12.33L10.2 13.58L11.2 12.58L9.95 11.33C10.31 11.08 10.64 10.77 10.89 10.41L12.14 11.66L13.14 10.66L11.89 9.41C12.22 8.55 12.22 7.58 11.89 6.72L13.14 5.47L12.14 4.47L10.89 5.72C10.64 5.36 10.31 5.05 9.95 4.8L11.2 3.55L10.2 2.55L8.95 3.8C8.3 3.55 7.63 3.55 7.05 3.8L5.8 2.55L4.8 3.55L6.05 4.8C5.69 5.05 5.36 5.36 5.11 5.72L3.86 4.47L2.86 5.47L4.11 6.72C3.78 7.58 3.78 8.55 4.11 9.41ZM6 8.06C6 6.95 6.9 6.06 8 6.06C9.1 6.06 10 6.95 10 8.06C10 9.16 9.1 10.06 8 10.06C6.9 10.06 6 9.16 6 8.06Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const MegaphoneIcon = () => {
  return (
    <svg
      ...
      width="16"
      viewBox="0 0 16 16"
      style={{ color: 'currentColor' }} // CSS의 color 속성으로 아이콘 색상 제어
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        // 이 d 값은 제공된 이미지의 형태를 최대한 유사하게 표현하도록 수동으로 작성되었습니다.
        // M (moveto), C (curveto - 베지어 곡선), L (lineto), V (vertical lineto), H (horizontal lineto), Z (closepath)
        d="M4.5 2C3.12 2 2 3.12 2 4.5v7C2 12.88 3.12 14 4.5 14H3v1.5h2V14h-.5l10.25 1.75c.69.15 1.25-.39 1.25-1.14V1.39c0-.75-.56-1.29-1.25-1.14L4.5 2zM5 4.5L14 2.5v11L5 11.5V4.5z"
        fill="currentColor"
      />
    </svg>
  );
