...
export const tools = {
  updateUserProfile: {
    description: `유저의 프로필을 업데이트 할때 사용되는 툴입니다.
  ...
  getSaju: {
    description: `유저의 사주 정보를 조회할때 사용되는 툴입니다. 사주 결과를 바탕으로 사주팔자와 음양오행, 십성을 보고 이 사람의 성격, 미래, 연애운, 금전운 등 사주팔자를 간결하게 해석해줘. 또한 미래에 조심해야할 것과 미래에 가까이해야할 것 등 전반적으로 이 사람이 인생을 잘 살아가는 데 필요한 것을 조언해줘. 특히 재물운과 연애운은 아주 자세하게 봐줘.`,
  },

  harmony: {
    getHarmony: {
      description: `두 사람의 연애 궁합을 봐주는 툴입니다. 두 사람의 사주 정보를 바탕으로 궁합을 분석하고 조언을 제공합니다. 유저가 입력한 정보가 parameters 형식에 안맞을 수 있으니 항상 검토하여 적합한 변수로 수정해주세요.  결과를 바탕으로 두 사람의 사주팔자와 음양오행, 십성을 보고 두 사람의 연애 궁합에 대해서 분석해줘. 또한 미래에 조심해야할 것과 미래에 가까이해야할 것 등 전반적으로 두 사람이 인생을 잘 살아가는 데 필요한 것을 조언해줘. 특히 재물운과 연애운은 아주 자세하게 봐줘.`,
      parameters: {
        name: {
          description: '상대방의 이름',
        },
