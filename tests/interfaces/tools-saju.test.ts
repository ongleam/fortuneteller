...
describe("SajuAITool", () => {
  describe("도구 생성 및 구조", () => {
    test("getSaju 도구 생성", () => {
      ...
      expect(sajuTool).toHaveProperty("inputSchema");
    ...
    test("파라미터 스키마 검증", () => {
      ...
      // Zod 스키마 구조 확인
      const inputSchema = sajuTool.inputSchema as any;
      expect(inputSchema).toBeDefined();
      expect(inputSchema._def).toBeDefined();
      expect(inputSchema._def.shape).toBeDefined();
