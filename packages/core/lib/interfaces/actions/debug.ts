...
import { getFourPillars } from "@fortuneteller/saju/four-pillars";
import {
  getReferenceFourPillars,
  getReferenceTenStars,
  getFiveElementsReference,
} from "@fortuneteller/saju/reference";
import { getTenStars } from "@fortuneteller/saju/ten-stars";
import { getFiveElements } from "@fortuneteller/saju/five-elements";
import type {
  BirthInput,
  FourPillars,
  TenStars,
