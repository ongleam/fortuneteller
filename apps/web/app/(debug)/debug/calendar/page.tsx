...
import {
  convertSolarToLunarAction,
  convertLunarToSolarAction,
} from "@/lib/interfaces/actions/calendar";
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="rounded-lg border bg-white p-6 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            {solarError && (
              <div className="rounded-md bg-red-50 p-3 text-sm text-red-600">{solarError}</div>
            )}
        ...
        <div className="rounded-lg border bg-white p-6 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="mb-2 flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    setLunarInput((prev) => ({ ...prev, isLeapMonth: e.target.checked }))
                  }
                  className="mr-2"
                />
            ...
            {lunarError && (
              <div className="rounded-md bg-red-50 p-3 text-sm text-red-600">{lunarError}</div>
            )}
