...
// SSOT는 @/lib/shared/types/chat. 기존 import 호환을 위해 re-export 한다.
export type { VisibilityType } from "@/lib/shared/types/chat";
import type { VisibilityType } from "@/lib/shared/types/chat";
