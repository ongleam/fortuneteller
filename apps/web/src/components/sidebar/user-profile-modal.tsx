...
import { cn } from "@fortuneteller/shared/utils";
  ...
  const TouchableItem = ({
    ...
    <button
      ...
      className={cn(
        ...
        "hover:bg-muted/50 focus:bg-muted/70 active:bg-muted focus:outline-none",
        danger &&
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        <div className="flex flex-col">
          {/* 계정 섹션 */}
          <div className="p-4">
            <h3 className="text-muted-foreground mb-2 px-1 text-sm font-medium">Account</h3>
          ...
          {/* 정보 섹션 */}
          <div className="p-4">
            <h3 className="text-muted-foreground mb-2 px-1 text-sm font-medium">Information</h3>
            <div className="overflow-hidden rounded-lg border">
              <Link href={siteConfig.termsOfService.url} className="block">
                <TouchableItem
                  icon={<FileText className="h-5 w-5" />}
                  label="Terms of Service"
                  rightContent={<ChevronRight className="text-muted-foreground h-4 w-4" />}
                />
              </Link>
          ...
          {/* 기타 섹션 */}
          <div className="p-4">
            <h3 className="text-muted-foreground mb-2 px-1 text-sm font-medium">Other</h3>
            <div className="overflow-hidden rounded-lg border">
              <TouchableItem
